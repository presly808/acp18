...
public class User extends Base {
    ...
    public User(int id, String name, double salary, int age, Department department, City city) {
        super(id, name);
        this.age = age;
        this.salary = salary;
        this.department = department;
    ...
    public User(int id, String name, double salary, int age, Department department, City city, User manage) {
        super(id, name);
        this.age = age;
        this.salary = salary;
        this.department = department;
